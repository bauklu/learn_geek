...
class Organic:
    ...
    def __add__(self, other):
        return Organic(self.n + other.n)

    def __sub__(self, other):
        return Organic(abs(self.n - other.n) if self.n != other.n \
                       else 'Количество ячеек одинаково, нельзя вычитать')

    def __mul__(self, other):
        return Organic(self.n * other.n)

    def __truediv__(self, other):
        return Organic(round(self.n / other.n))

    def __str__(self):
        return f'Ячеек: {self.n}'

    def make_order(self, cells ):
        return '\n'.join(['*' * cells for _ in range(self.n // cells)]) + '\n' + '*' * (self.n % cells)
